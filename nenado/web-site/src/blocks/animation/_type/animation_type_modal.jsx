...
class Animation extends React.Component {
	...
	startAnimation(direction) {
		const noAnimate = direction == null;
		...
		this._postPrepareTimeout = setTimeout(::this.postPrepareAnimation, 100);
	...
	render() {
		...
		return (
			<div
				...
				className={classNames('animation_type_modal', className, {
					close: type != null && !type,
					open: type != null && type,
